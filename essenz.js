/* ------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------- */
import { cevir, toplam, kalan } from "./ebced.js?v=8";
import { BURCLAR, UNSURLAR, GEZEGENLER } from "./korpus.js?v=8";
import { leseProfil, profilBeschriftung, zurDateneingabe } from "./profil.js?v=8";
