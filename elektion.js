/* ------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------- */
import { MENZILLER } from "./korpus.js?v=67";
import { planetenPositionen, julianischesDatum, norm360, sonnenLaenge } from "./astro.js?v=67";
import { ZEICHEN, PLANET } from "./horoskop.js?v=67";
