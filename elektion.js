/* ------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------- */
import { MENZILLER } from "./korpus.js?v=50";
import { planetenPositionen, julianischesDatum, norm360, sonnenLaenge } from "./astro.js?v=50";
import { ZEICHEN, PLANET } from "./horoskop.js?v=50";
