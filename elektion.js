/* ------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------- */
import { MENZILLER } from "./korpus.js?v=70";
import { planetenPositionen, julianischesDatum, norm360, sonnenLaenge } from "./astro.js?v=70";
import { ZEICHEN, PLANET } from "./horoskop.js?v=70";
