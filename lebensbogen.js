/* ------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------- */
import { leseProfil, aufProfilAenderung, profilBeschriftung, zurDateneingabe } from "./profil.js?v=23";
import { berechneGeburt } from "./astro.js?v=23";
import { berechneDirektionen, PLANETEN, PLANETEN_REIHE, ACHSEN } from "./direktionen.js?v=23";
