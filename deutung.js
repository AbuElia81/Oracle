/* ------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------- */
import { leseProfilRoh } from "./profil.js?v=67";
import { profektionJetzt } from "./jahr.js?v=67";
import { zustandVon, radix, HAUS, mitArtikel, grossMitArtikel } from "./horoskop.js?v=67";
