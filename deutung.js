/* ------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------- */
import { leseProfilRoh } from "./profil.js?v=59";
import { profektionJetzt } from "./jahr.js?v=59";
import { zustandVon, radix, HAUS, mitArtikel, grossMitArtikel } from "./horoskop.js?v=59";
