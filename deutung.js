/* ------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------- */
import { leseProfilRoh } from "./profil.js?v=70";
import { profektionJetzt } from "./jahr.js?v=70";
import { zustandVon, radix, HAUS, mitArtikel, grossMitArtikel } from "./horoskop.js?v=70";
